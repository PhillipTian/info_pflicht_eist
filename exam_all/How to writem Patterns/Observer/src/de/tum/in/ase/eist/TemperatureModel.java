...
public class TemperatureModel extends Subject<Double> {
    ...
    public void increaseK(double tempK) {
        final double currentK = TemperatureConverter.convertCelsiusToKelvin(celsiusTemperature);
        final double newK = currentK + tempK;

        setC(TemperatureConverter.convertKelvinToCelsius(newK));
    }
